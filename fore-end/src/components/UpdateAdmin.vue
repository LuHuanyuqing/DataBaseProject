        ...
        <div class="card-body">
          <form qw-c="operationform" action="#" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group" qw-c="forminputcomponent">
              ...
              <input maxlength="-1" v-model="admin.username" name="username" id="username" type="text" readonly
            ...
            <button class="btn btn-primary" type="button" v-on:click="updateadminact()">修改</button>
          </form>
        </div>
      </div>
    </div>
