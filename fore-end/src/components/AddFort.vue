        ...
        <div class="card-body">
          <form qw-c="operationform" action="#" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group" qw-c="forminputcomponent">
              ...
              <input maxlength="-1" v-model="fort.username" name="username" id="username" type="text" qw-c="forminput"
                     class="form-control">
            </div>
            <div class="form-group" qw-c="forminputcomponent">
            ...
            <button class="btn btn-primary" type="button" v-on:click="addfortact()">添加</button>
          </form>
        </div>
      </div>
    </div>
  ...
  export default {
    ...
    methods: {
      ...
      serializeForm(formid) {
        ...
        let _this = this;
        this.$axios.post("/addfortactjson.action", _this.serializeForm())
          .then(res => {
