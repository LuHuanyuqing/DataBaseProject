                                    ...
                                    <div class="table-responsive">
                                        <table id="example" class="display min-w850" qw-c="table">
                                            ...
                                            <tr v-for="item in familyall" :key="item.id">
                                                ...
                                                <td>{{ item.username }}</td>
                                                <td>
                                                    <a :href="'/#/FamilyTree?familyid=' + item.id">家族树</a>
                                                    <a :href="'/#/UpdateFamily?id=' + item.id">修改</a>
                                                    <a href="javascript:;;" @click="deletefamilyjson(item.id)">删除</a>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
    ...
    export default {
        ...
        methods: {
            ...
            searchfamily: function () {
                ...
                this.$axios
                    ...
                    .then((res) => {
                        ...
                        //"                    <td><a href='updatefamily.html?id=" + item['id'] + "'>修改</a> <a href='javascript:;;' onclick='deletefamilyjson(" + item['id'] + ")'>删除</a></td>"+
                        //"                </tr>"
                        //)
                        //}
                        //表单数据更新处理部分
            ...
            deletefamilyjson: function (id) {
                let _this = this;
                this.$axios
                    .post("/deletefamilyjson.action?id=" + id, "")
                    .then((res) => {
                        this.$message({
                            message: "删除家族信息成功",
                            type: "success",
