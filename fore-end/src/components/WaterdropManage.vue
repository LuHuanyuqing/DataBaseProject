            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row" style="margin-bottom: 40px;">
                        <div class="col-md-6">
                            <div class="form-inline mb-5">
                                ...
                                <input maxlength="-1" type="text" class="form-control mb-2 mr-sm-2" id="search"
                                       placeholder="请输入关键字">
                    ...
                    <table qw-c="table">
                        ...
                        <tbody id="tbody">
                        <tr v-for="item in waterdropall" :key="item.id">
                            <td><img :src="'http://localhost:8080/patriarchalclan/resource/uploads/' + item['imagee']"
                            ...
                            <td><a :href="'/#/UpdateWaterdrop?id=' + item.id">修改</a><a href="javascript:;;"
                                                                                       @click="deletewaterdropjson(item.id)">删除</a>
                            </td>
                        </tr>
                        </tbody>
                    </table>
                        ...
                        <div class="col-md-6">
                            <nav aria-label="分页">
                                <ul class="pagination justify-content-end">
                                    ...
                                    <li class="active page-item"><a class="page-link" href="#" id="dangqianye">1</a>
                                    </li>
                                    <li class="page-item"><a class="page-link" href="javascript:;" id="xiayiye">下一页</a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
            ...
            serializeForm(formid) {
                ...
                this.$axios.post("/searchwaterdropjson.action", "")
                    .then(res => {
                        ...
                        //$("tbody").html("");
                        //for (var i = 0; i < _this.waterdropall.length; i++){
                        //var item = _this.waterdropall[i];
                        //$("tbody").append(
                        //"                <tr>" +
//"                    <td><img src='http://localhost:8080/patriarchalclan/resource/uploads/"+ item['imagee'] +"' style='width: 100px;height: 100px;'></td>"+
                        //"                    <td>"+ item['fort'] +"</td>" +
                        //"                    <td>"+ item['name'] +"</td>" +
                        //"                    <td>"+ item['birthday'] +"</td>" +
                        //"                    <td>"+ item['father'] +"</td>" +
//"                    <td><a href='updatewaterdrop.html?id=" + item['id'] + "'>修改</a> <a href='javascript:;;' onclick='deletewaterdropjson(" + item['id'] + ")'>删除</a></td>"+
                        //"                </tr>"
                        //)
                        //}
                        //表单数据更新处理部分
            ...
            deletewaterdropjson: function (id) {
                let _this = this;
                this.$axios.post("/deletewaterdropjson.action?id=" + id, "")
                    .then(res => {
                        this.$message({
                            message: '删除家庭成员信息成功',
                            type: 'success'
