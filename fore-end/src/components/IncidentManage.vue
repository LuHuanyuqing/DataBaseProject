            ...
            <div class="content-body" style="padding-top: 0">
                <div class="container-fluid">
                    <div class="page-titles">
                        <h4 qw-c="operationname">人员事件管理</h4>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                    ...
                                    <div class="table-responsive">
                                        <table id="example" class="display min-w850" qw-c="table">
                                            ...
                                            <tr v-for="item in incidentall" :key="item.id">
                                                ...
                                                <td>{{ item.family }}</td>
                                                <td>
                                                    <a :href="'/#/UpdateIncident?id=' + item.id">修改</a
                                                    ><a
                                                        href="javascript:;;"
                                                        @click="deleteincidentjson(item.id)"
                                                >删除</a
                                                >
                                                </td>
                                            </tr>
    ...
    export default {
        ...
        methods: {
            ...
            searchincident: function () {
                let _this = this;
                this.$axios
                    .post("/searchincidentjson.action", "")
                    .then((res) => {
                        var obj = res["data"];
                        console.log(obj);
                        ...
                        //"                    <td>"+ item['family'] +"</td>" +
                        //"                    <td><a href='updateincident.html?id=" + item['id'] + "'>修改</a> <a href='javascript:;;' onclick='deleteincidentjson(" + item['id'] + ")'>删除</a></td>"+
                        //"                </tr>"
                        //)
                        //}
                        //表单数据更新处理部分
            ...
            deleteincidentjson: function (id) {
                let _this = this;
                this.$axios
                    .post("/deleteincidentjson.action?id=" + id, "")
                    .then((res) => {
                        this.$message({
                            message: "删除人员事件信息成功",
                            type: "success",
