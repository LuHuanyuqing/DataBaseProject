                                    ...
                                    <div class="auth-form">
                                        ...
                                        <form action="#" qw-c="form" method="post">
                                            <div class="form-group">
                                                ...
                                                <input maxlength="-1" qw-c="username" name="username"
                                                       class="form-control" type="text" placeholder="请输入用户名">
                                            </div>
                                            <div class="form-group">
                                                <label class="mb-1 text-white"><strong>密码</strong></label>
                                                <input maxlength="-1" qw-c="password" name="password" type="password"
                                                       placeholder="请输入密码" class="form-control">
                                            </div>

                                            <div class="form-group" qw-c="passwordcomponent"><label
                                                    class="mb-1 text-white"><strong>确认密码</strong></label> <input
                                                    maxlength="-1" qw-c="password" name="repassword" type="password"
                                                    class="form-control" placeholder="请输入密码"></div>
                                            ...
                                            <div class="text-center">
                                                <button class="btn bg-white text-primary btn-block" type="button"
                                                        @click="registact">注册
                                                </button>
                                            </div>
                                        </form>
