            ...
            <div class="content-body" style="padding-top: 0">
                <div class="container-fluid">
                    <div class="page-titles">
                        <h4 qw-c="operationname">添加家庭成员</h4>
                    </div>
                    <div class="row">
                                    ...
                                    <div class="basic-form">
                                        ...
                                        >
                                            ...
                                            <div class="form-group" qw-c="forminputcomponent">
                                                ...
                                                <img
                                                        onerror='src="/static/error.jpg"'
                                                        :src="
                            'http://localhost:8081/familytree/resource/uploads/' +
                            member.avatar
                          "
                                                        id="avatarimg"
                                                        style="
                          ...
                          "
                                            ...
                                            <div class="form-group" qw-c="formselectcomponent">
                                                ...
                                                <input
                                                        ...
                                                        name="family"
                                                        id="family"
                                                        v-model="member.family"
                                                /><select
                                                    v-model="member.familyid"
                                            ...
                                            <div class="form-group" qw-c="formselectcomponent">
                                                ...
                                                <input
                                                        ...
                                                        name="father"
                                                        id="father"
                                                        v-model="member.father"
                                                /><select
                                                    v-model="member.fatherid"
                                            ...
                                            <div class="form-group" qw-c="formselectcomponent">
                                                ...
                                                <input
                                                        ...
                                                        name="mother"
                                                        id="mother"
                                                        v-model="member.mother"
                                                /><select
                                                    v-model="member.motherid"
                                            ...
                                            <div class="form-group" qw-c="formselectcomponent">
                                                ...
                                                <input
                                                        ...
                                                        name="spouses"
                                                        id="spouses"
                                                        v-model="member.spouses"
                                                /><select
                                                    v-model="member.spousesid"
    ...
    export default {
        ...
        methods: {
            ...
            searchfamily() {
                ...
                this.$axios
                    ...
                    .then((res) => {
                        ...
                        _this.member.familyid = _this.familyall[0]["id"];
                        _this.member.family = _this.familyall[0]["name"];
                    })
                    .catch((err) => {
                        console.log(err);
                    });
            ...
            familychange: function () {
                let _this = this;
                _this.member.family = _this.familyall.filter(function (item) {
                    return item.id == _this.member.familyid;
                })[0]["name"];
                _this.$forceUpdate();
            },
            searchmember() {
                ...
                this.$axios
                    ...
                    .then((res) => {
                        ...
                        //_this.member.fatherid = _this.memberall[0]["id"];
                        //_this.member.father = _this.memberall[0]["name"];

                        _this.fatherall = _this.memberall.filter(item => {
                            console.log(item.gender);
                            return item.gender === '男';
                        })

                        _this.motherall = _this.memberall.filter(item => {
            ...
            addmemberact: function () {
                let _this = this;
                this.$axios
                    .post("/addmemberactjson.action", _this.serializeForm())
                    .then((res) => {
                        ...
                        _this.$router.push("/MemberManage");
                    })
                    .catch((err) => {
                        console.log(err);
                        _this.$message({
