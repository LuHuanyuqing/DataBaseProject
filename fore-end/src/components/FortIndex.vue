        ...
        <div class="card-body">
          <form qw-c="operationform" action="#" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group" qw-c="forminputcomponent">
              ...
              <input maxlength="-1" v-model="userinfo.name" name="name" id="name" type="text" qw-c="forminput"
                     class="form-control">
            </div>
            <div class="form-group" qw-c="forminputcomponent">
            ...
            <div class="form-group" qw-c="formtextareacomponent">
              ...
              <textarea v-model="userinfo.infoo" name="infoo" id="infoo" class="form-control" rows="3"
...
<script>
  ...
  export default {
      ...
      serializeForm(formid) {
        ...
        this.$axios.post("/updatefortactjson.action", _this.serializeForm())
          .then(res => {
            ...
            var obj = res.data;
            this.$axios.post("/fortdetailsjson.action?id=" + _this.userinfo['id'], _this.serializeForm())
              .then(res => {
                console.log(res);
                var obj = res.data;
                _this.userinfo = obj['fort'];
    ...
    created() {
      ...
      _this.fortdetailsjson(sessionStorage.getItem("id"));
    },
    beforeCreate() {
