  ...
  <div class="container"> 
   <div class="row"> 
    <div class="col-md-4 col-md-offset-4 login-box"> 
     <h2 class="text-center" qw-c="operationname">登录</h2> 
     <form qw-c="form" action="loginact.action" method="post"> 
      ...
      <div class="form-group"> 
       ...
       <select class="form-control" id="identity" qw-c="identity" name="shenfen"><option>管理员</option><option>家族</option></select> 
      </div> 
      <div class="form-group"> 
       <button type="submit" class="btn btn-block btn-lg" qw-c="operationbutton">登录</button> 
      </div> 
