 ...
 <body> 
  ...
  <div id="content"> 
   <div class="card"> 
    ...
    <div class="card-body"> 
     <form qw-c="operationform" action="tianjiatasteact.action" method="post" enctype="multipart/form-data">
      <div class="form-group" qw-c="formselectcomponent"> 
 <label qw-c="formselecttext">成员</label> 
  <!-- 定义waterdrop下拉框 并定义其onchange方法waterdropchange(this)" -->  

<select id='waterdrop' onchange="waterdropchange(this)"name="waterdrop" class="form-control" qw-c="formselect">  <!-- 用c标签的if表达式判断waterdropall是否为空  -->  
...
<div style='display:none;' class="form-group" qw-c="formselectcomponent"> 
 <label qw-c="formselecttext">成员id</label> 
  <!-- 定义waterdropid下拉框 并定义其onchange方法waterdropchange(this)" -->  

<select id='waterdropid' onchange="waterdropchange(this)"name="waterdropid" class="form-control" qw-c="formselect">  <!-- 用c标签的if表达式判断waterdropall是否为空  -->  
...
<textarea name="content" class="form-control" rows="3" qw-c="formtextarea"></textarea> 
