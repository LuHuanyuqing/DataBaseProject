 ...
 <body> 
  ...
  <div id="content"> 
   <div class="card"> 
     ...
     <table qw-c="table">
       <thead><th>头像
                    ...
                    <c:if test="${ !empty waterdropall}">
                        ...
                        <a href="resource/uploads/${item.imagee }"><img src="resource/uploads/${item.imagee }" style="height:100px;width:100px;"/></a>
	...
	<!--  定义修改家庭成员按钮和删除家庭成员按钮，修改提交地址为fortxiugaiwaterdrop.action?id=${item.id}，删除提交地址为 fortshanchuwaterdrop.action?id=${item.id}-->

                          <a href="fortxiugaiwaterdrop.action?id=${item.id}">修改</a>   <a href="fortshanchuwaterdrop.action?id=${item.id}">删除</a>
