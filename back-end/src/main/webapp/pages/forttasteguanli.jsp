 ...
 <body> 
  ...
  <div id="content"> 
   <div class="card"> 
	...
	<!--  定义修改成员事件按钮和删除成员事件按钮，修改提交地址为fortxiugaitaste.action?id=${item.id}，删除提交地址为 fortshanchutaste.action?id=${item.id}-->

                          <a href="fortxiugaitaste.action?id=${item.id}">修改</a>   <a href="fortshanchutaste.action?id=${item.id}">删除</a>
