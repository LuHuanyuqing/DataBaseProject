 ...
 <body> 
  ...
  <div id="content"> 
   <div class="card"> 
	...
	<!--  定义修改家庭成员按钮和删除家庭成员按钮，修改提交地址为xiugaiwaterdrop.action?id=${item.id}，删除提交地址为 shanchuwaterdrop.action?id=${item.id}-->

                          <a href="xiugaiwaterdrop.action?id=${item.id}">修改</a>   <a href="shanchuwaterdrop.action?id=${item.id}">删除</a>
