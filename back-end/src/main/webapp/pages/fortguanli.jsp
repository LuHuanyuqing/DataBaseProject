 ...
 <body> 
  ...
  <div id="content"> 
   <div class="card"> 
	...
	<!--  定义修改家族按钮和删除家族按钮，修改提交地址为xiugaifort.action?id=${item.id}，删除提交地址为 shanchufort.action?id=${item.id}-->

                          <a href="xiugaifort.action?id=${item.id}">修改</a>   <a href="shanchufort.action?id=${item.id}">删除</a>
